...
$arrAAD_StandardUsers = Get-MgUser -UserId "mark.connelly.admin@carle.online" -Property "CustomSecurityAttributes"
$arrAAD_StandardUsers | ConvertTo-Json | out-file -filepath "C:\temp\Get-MgUser-markconnellyadmin.json"
$test = Get-MgUser -UserId "mark.connelly.admin@carle.online" -Property * | ConvertTo-Json | out-file -filepath "C:\temp\Get-MgUser-markconnellyadmin.json"
